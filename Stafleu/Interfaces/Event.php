...
interface Event
{
     ...
     * @param string $enacter   Who triggered this event. By default, this is
     *                          the program. Ideally, this parameter will be
     *                          used to prevent the program from accessing
     *                          certain operations. Therefore, never set this
     *                          parameter, except during original Dispatch
     */
